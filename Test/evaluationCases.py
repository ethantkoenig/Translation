...
NonSemiItaToEng = [
  ...
  ("il ragazzo che ha fatto una promessa è uno studente",
    union("the boy (that|who) made a promise is a student",
...
SemiItaToEng = [
  ...
  ("mi chiamo Joe",
    ["my name is Joe"]),
  ("la donna con lo studente che si chiama Joe sarebbe stata felice",
    union("the woman with the student (named|whose name is) Joe would have been happy")),
  ...
  ("la donna che avrebbe fame si chiama Emma",
    union("the woman (that|who) would be hungry's name is Emma")),
